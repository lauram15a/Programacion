 ...
 * @author laura
 */
public class PartidaInterfazContinuarPartida extends javax.swing.JFrame {
    ...
    public PartidaInterfazContinuarPartida(HashMap<String, clases.Historial> torne, Usuario usuari, String dificulta) {
        usuario = usuari;
        torneo = torne;
        dificultad = dificulta;
        initComponents();transparenciaBoton();
        ...
        textField_turno_Partida.setText(Integer.toString(contadorTurno[0]));
        
        asignarNombreJLabel();
        tablero = Tablero.rellenarTableroInterfaz(5, 9, casillaVacia);
        textField_numSoles_Partida.setText(Integer.toString(soles[0]));
    ...
    private void initComponents() {
        ...
        textField_numSoles_Partida = new javax.swing.JTextField();
        textField_lineaComandos_Partida = new javax.swing.JTextField();
        textField_turno_Partida = new javax.swing.JTextField();
        ...
        textField_numSoles_Partida.setFont(new java.awt.Font("Cooper Black", 0, 18)); // NOI18N
        textField_numSoles_Partida.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        textField_numSoles_Partida.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                textField_numSoles_PartidaActionPerformed(evt);
            }
        });
        textField_numSoles_Partida.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                textField_numSoles_PartidaKeyTyped(evt);
            }
        });
        getContentPane().add(textField_numSoles_Partida, new org.netbeans.lib.awtextra.AbsoluteConstraints(20, 92, 80, 30));

        textField_lineaComandos_Partida.setFont(new java.awt.Font("Cooper Black", 0, 13)); // NOI18N
        ...
        textField_turno_Partida.setFont(new java.awt.Font("Cooper Black", 0, 13)); // NOI18N
        textField_turno_Partida.setHorizontalAlignment(javax.swing.JTextField.CENTER);
        textField_turno_Partida.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyTyped(java.awt.event.KeyEvent evt) {
                textField_turno_PartidaKeyTyped(evt);
            }
        });
        getContentPane().add(textField_turno_Partida, new org.netbeans.lib.awtextra.AbsoluteConstraints(679, 60, 40, -1));
    ...
    private void textField_numSoles_PartidaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_textField_numSoles_PartidaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_textField_numSoles_PartidaActionPerformed

    private void textField_numSoles_PartidaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textField_numSoles_PartidaKeyTyped
        // No admite el ingreso ni de letras ni de caracteres
        char c = evt.getKeyChar();
        if (c < 'a' || c > 'z' || c < '0' || c > '9') {
            evt.consume();
        }
    }//GEN-LAST:event_textField_numSoles_PartidaKeyTyped

    private void textField_turno_PartidaKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_textField_turno_PartidaKeyTyped
        // No admite el ingreso ni de letras ni de caracteres
        char c = evt.getKeyChar();
        if (c < 'a' || c > 'z' || c < '0' || c > '9') {
            evt.consume();
        }
    }//GEN-LAST:event_textField_turno_PartidaKeyTyped
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {  //enter
            ...
            if (!ExcepcionJuego.comprobarInstruccion(listaLineaComandos)) { //está mal
                ...
                if ("AYUDA".equals(listaLineaComandos[0].toUpperCase())) {
                    ...
                    partida(listaLineaComandos, modoSeleccion, posicionTablero, soles, contadorTurno, turnosSinZombies(), numZombies());
                }
    ...
    public void partida(String[] listaLineaComandos, String modoSeleccion, String posicionTablero, int[] soles, int[] contadorTurno, int[] turnosInicialesSinZombis, int numZombis) {
        ...
        if ("G".equals(modoSeleccion) || "L".equals(modoSeleccion) || "N".equals(modoSeleccion) || "P".equals(modoSeleccion)) {
            ...
            if ((filaObjeto < 0 || filaObjeto > numFilas - 1) || (columnaObjeto < 0 || columnaObjeto > numFilas - 1)) {  //fuera tablero
                JOptionPane.showMessageDialog(null, "Fuera del tablero.");
            } else {
                if (filaObjeto == numColumnas - 1) { //última casilla
        ...
        System.out.println("1: " + turnosInicialesSinZombis[0]);
        turnosInicialesSinZombis[0]--;
        System.out.println("2: " + turnosInicialesSinZombis[0]);
        ...
        if (comprobadorImprimir == true) {
            turnosInicialesSinZombis[0]--;
            System.out.println("turno : "+turnosInicialesSinZombis[0]);
        } else {
            contadorTurno[0]--;
        }
    ...
    private javax.swing.JTextField textField_numSoles_Partida;
    private javax.swing.JTextField textField_turno_Partida;
